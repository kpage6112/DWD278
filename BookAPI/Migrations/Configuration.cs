    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookAPI.Models.BookAPIContext>
    {
        ...
        protected override void Seed(BookAPI.Models.BookAPIContext context)
        {
            context.Authors.AddOrUpdate(new Author[] {
                new Author() { AuthorId = 1, AuthorName = "Ralls, Kim" },
                new Author() { AuthorId = 2, AuthorName = "Corets, Eva" },
                new Author() { AuthorId = 3, AuthorName = "Randall, Cynthia" },
                new Author() { AuthorId = 4, AuthorName = "Thruman, Paula"}                 
           });
